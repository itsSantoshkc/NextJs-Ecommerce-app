...
const Footer = () => {
  return (
    ...
    <footer className="text-white body-font dark:bg-gray-900">
      <div className="container px-5 py-24 mx-auto flex md:items-center lg:items-start md:flex-row md:flex-nowrap flex-wrap flex-col">
        <div className="w-64 flex-shrink-0 md:mx-0 mx-auto text-center md:text-left">
          <a className="flex title-font font-medium items-center md:justify-start justify-center text-gray-900">
            <img src="/logo.svg" className="w-10 h-10 " alt="" />
            <span className="ml-3 text-white font-bold text-xl">Tailblocks</span>
          </a>
        ...
        <div className="flex-grow flex flex-wrap md:pl-20 -mb-10 md:mt-0 mt-10 md:text-left text-center">
          <div className="lg:w-1/4 md:w-1/2 w-full px-4">
            ...
            <nav className="list-none mb-10">
              <li>
                <Link href={'/tshirts'}>
                  <a className="text-white hover:text-gray-800 cursor-pointer">Tshirt</a>
                </Link>
              </li>
              <li>
                <Link href={'/hoodies'}>
                  <a className="text-white hover:text-gray-800">Hoodies</a>
                </Link>
              </li>
              <li>
                <Link href={'/mugs'}>
                  <a className="text-white hover:text-gray-800">Mugs</a>
                </Link>
              </li>
              <li>
                <Link href={'/stickers'}>
                  <a className="text-white hover:text-gray-800">Stickers</a>
                </Link>
              </li>
            </nav>
          </div>
      ...
      <div className="bg-gray-100">
        <div className="container mx-auto py-4 px-5 flex flex-wrap flex-col sm:flex-row">
          <p className="text-gray-500 text-sm text-center sm:text-left">© 2020 Tailblocks —
            <a href="https://twitter.com/knyttneve" rel="noopener noreferrer" className="text-grey-500 ml-1" target="_blank">@knyttneve</a>
          </p>
